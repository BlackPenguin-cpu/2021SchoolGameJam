...
public class Player : Entity
{
    ...
    void PlayerAttack()
    {
        if (attackAble)
        {
            ...
            {
                case 0:
                    SoundManager.Instance.PlaySound("ÈÖµÎ¸£±â1");
                    break;
                case 1:
                    SoundManager.Instance.PlaySound("ÈÖµÎ¸£±â2");
                    break;
                case 2:
                    SoundManager.Instance.PlaySound("ÈÖµÎ¸£±â3");
                    break;
                default:
                    break;
            }
    ...
    protected override void Hit()
    {
        if (playerState != PlayerState.Die && playerState != PlayerState.Skill)
        {
            SoundManager.Instance.PlaySound("ÇÃ·¹ÀÌ¾îÇÇ°Ý");
